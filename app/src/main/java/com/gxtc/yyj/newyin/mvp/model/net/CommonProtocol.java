...
public class CommonProtocol extends BaseProtocol {
     ...
     * @param reqType     请求类型
     */
    public void updateUserInfo(String accessToken, String uid, Callback<UserInfo> callback, int reqType) {
        execute(getIHttpService().updateUserInfo(accessToken,uid), callback, reqType);
    }
}
